            ...
            if higher == False:
                if number[len(number)-iter_ater] != "0":
                    ...
                    if spaces:
                        word += " "
            higher = False
            if number[(len(number)-iter_ater+1):] != "00":
               word += "and"
               if spaces:
                word += " "
        if iter_ater == 2:
            ...
            if clean != "CRY":
                word += clean
                if spaces and number[(len(number)-iter_ater+1):] != "0" and clean != "":
                    word += "-"
            else:
                higher = True
                if number[(len(number)-iter_ater+1):] == "0":
                    word += "ten"
                elif number[(len(number)-iter_ater+1):] == "1":
                    word += "eleven"
                elif number[(len(number)-iter_ater+1):] == "2":
                    word += "twelve"
                elif number[(len(number)-iter_ater+1):] == "3":
                    word += "thirteen"
                elif number[(len(number)-iter_ater+1):] == "5":
                    word += "fifteen"
                elif number[(len(number)-iter_ater+1):] == "8":
                    word += "eighteen"
                else:
