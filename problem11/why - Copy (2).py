...
#print(hell[0][len(hell[0])-1])
#len-1 returns the last index number
...
for y_pos in range(len(hell)):
    ...
    for x_pos in range(len(hell[y_pos])):
        ...
        if x_pos+length < len(hell[y_pos]): #left to right
            #teststring = ""
            testnum = 1
            ...
            if y_pos+length < len(hell): #down right diag
                #teststring = ""
                testnum = 1
                for i in range(0, length+1):
                 #   teststring += hell[y_pos+i][x_pos+i]
                    ...
                    if testnum == 0:
                        break
                print("y:"+str(y_pos)+",x:"+str(x_pos),hell[y_pos][x_pos], hell[y_pos+length][x_pos+length])
                #print(teststring)
                if testnum > biggest_product:
                    biggest_product = testnum
        if y_pos+length < len(hell):
            testnum = 1
            for i in range(0, length+1):
        ...
        if x_pos-length >= 0:
            if y_pos+length < len(hell):
                ...
                for i in range(0, length+1):
                    ...
                    if testnum == 0:
                        break
                #print("y:"+str(y_pos)+",x:"+str(x_pos),hell[y_pos][x_pos], hell[y_pos+12][x_pos-12])
                if testnum > biggest_product:
                    biggest_product = testnum
print(biggest_product)
